...
> = {
  data: {
    ...
    accent: '#60a5fa',
    links: [
      { label: 'UrbanSense', href: '/urbansense' },
      { label: 'CityForesight', href: '/cityforesight' },
    ],
  },
  tools: {
    title: 'Tools',
    ...
    links: [
      { label: 'CityForesight', href: '/cityforesight' },
      { label: 'Urban Climate Copilot', href: '/cityforesight' },
  ...
  decisions: {
    ...
    accent: '#38bdf8',
    links: [{ label: 'CityForesight Dashboard', href: '/cityforesight' }],
  },
}
